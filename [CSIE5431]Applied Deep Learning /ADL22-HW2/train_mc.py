...
def main(args):
    ...
    # Model
    model = AutoModelForMultipleChoice.from_pretrained(args.pretrained_model_name_or_path)
    model.to(device)
    ...
    with accelerator.main_process_first(): 
        train_dataset_file = args.processed_data_dir / "train_token.json"
        train_dataset = MC_Dataset(train_dataset_file)

        valid_dataset_file = args.processed_data_dir / "valid_token.json"
